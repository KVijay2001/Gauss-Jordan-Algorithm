...
# FOLLOWING ALGORITHM WORKS FOR ANY SQUARE MATRICES : TAKES A LINEAR SYSTEM OF EQUATIONS IN THE FORM OF A LIST OF LISTS 
# AND RETURNS A LIST CONATNING ALL THE SOLUTIONS !
